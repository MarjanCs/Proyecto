...
public class ListaPersonasRecycler extends AppCompatActivity {
    ...
    private void consultarListaPersonas() {
        ...
        while (cursor.moveToNext()){
            ...
            usuario.setAsistencia(cursor.getString(2));
    ...
    private void llenarListaUsuarios() {
        listaUsuario.add(new Usuario(1,"Cristian","5526"));
        listaUsuario.add(new Usuario(1,"luis","54"));
        listaUsuario.add(new Usuario(1,"Cristian","485"));
